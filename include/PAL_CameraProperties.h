...
namespace PAL
{
	...
	{
		const Resolution _3440x713 = { .width = 3440,.height = 713 };
        	const Resolution _2304x480 = { .width = 2304,.height = 480 };
        	const Resolution _1720x356 = { .width = 1720,.height = 356 };
        	const Resolution _860x180 = { .width = 860,.height = 180 };
    	}
