...
CODE SAMPLE # 004: PAL Mini Video Capture
...
int main( int argc, char** argv )
{
	...
	namedWindow( "PAL Mini Video Capture", WINDOW_NORMAL ); // Create a window for display.
	...
	resizeWindow("PAL Mini Video Capture", width, 2*height);
	...
	imshow( "PAL Mini Video Capture", output);
