...
int main( int argc, char** argv )
{
	...
	namedWindow( "PAL Mini Camera Properties", WINDOW_NORMAL ); // Create a window for display.
	...
	resizeWindow("PAL Mini Camera Properties", width, height);
	...
	imshow( "PAL Mini Camera Properties", output);
	...
	while(key != 27)
	{
		...
		imshow( "PAL Mini Camera Properties", display);  
